...
from PySide2.QtGui import QColor, QBrush, QPen, QPainterPath, QPainter, QFont, QPolygonF
...
class Chip(QGraphicsItem):
    ...
    def paint(self, painter: QPainter, option: QStyleOptionGraphicsItem, widget: QWidget = ...):
        fillColor = self.color.dark(150) if option.state & QStyle.State_Selected else self.color
        ...
        pen.setWidth(width)
        b = painter.brush()
        painter.setBrush(QBrush(fillColor.dark(120 if option.state & QStyle.State_Sunken else 100)))
